...
The predictive power of the recurrent neural networks known as the Echo
State Network is not as strong for chaotic problems. Measured by
...
circular three body problem solution had an LCE of 0.176 and a
predictability power as strong as 10 Lyapunov times. 
Other methods may be applied to improve the results, but in general
it seems the predictability is very low for very chaotic systems.
