...
30, 60, \text{and} 75$. The results for the ESN weren't very strong, and none 
...
The steep increase in error and the subsequent slowing of increase in error
seen in the graphs below suggests that this might be the case.
...
0.2, and one show below (Figure \ref{fig:3brounded}) shows an RMSE not rising 
above 0.1 despite its not as elliptical looking shape. Further, this model
